...
const Login = () => {
  ...
  return (
    ...
    <img className="login_img" src="/login/21.png" style={{position:"absolute", width:"2500px", transform:"translate(-1500px, 0px) rotate(-10deg)", zIndex:"-1"}}  />
    ...
    <Box sx={{backgroundColor:"F3E8E2", height:"100vh", width:"100%", backgroundSize:"cover", backgroundPosition:"bottom right", position:"fixed"}}>
      ...
      <img className="login_img" src="/login/21.png" style={{position:"absolute", width:"2500px", transform:"translate(-1500px, 0px) rotate(-10deg)", zIndex:"-1"}}  />
        ...
        <Stack spacing={2}>
          ...
          <TextField fullWidth label="Email Address" required variant="filled" onChange={(e)=>inputEmail(e)}/>
          <TextField fullWidth label="Password" required variant="filled" type="password" onChange={(e)=>inputPassword(e)}/>
        </Stack>
